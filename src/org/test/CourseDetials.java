...
public class CourseDetials {
	...
	private void methodOfFile() {
		...
		/*
		 * boolean b = f.mkdir(); System.out.println(b); boolean c = f.mkdirs();
		 * System.out.println(c); boolean fileobject = f.createNewFile();
		 * System.out.println(fileobject); boolean cr1 = f.canRead();
		 * System.out.println(cr1); boolean cr2 = f.canWrite(); System.out.println(cr2);
		 * boolean hidden = f.isHidden(); System.out.println(hidden);
		 */
		String[] list = f.list();
